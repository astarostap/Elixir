...
questions_list = [
  [ "Is gatorade better for you than water when exercising?", "What to do if I do an hour full body workout should what to do if i drink water or gatorade while i work out?", "Gatorade", "Water", "http://briangreen.net/files/2013/10/elixir-00-640x480.jpg" ],
  [ "Are superfoods a real thing?", "What should I buy at the grocery store to stay healthy? Which foods are superfoods?", "There are superfoods", "No such thing", "http://blog.houstonmethodist.org/wp-content/uploads/2014/08/superfood-quiz-featured.jpg"],
